...
<style>
    ...
    .modal-avatar-lg{
        width:110px; height:110px; border-radius:30px; object-fit:cover;
        border:3px solid var(--accent);
        box-shadow:0 20px 35px -12px rgba(0,0,0,0.5), 0 0 0 3px rgba(249,177,122,0.2);
        display:block; margin:0 auto 1rem; background:var(--deep);
    }
    .modal-avatar-init{
...
<div class="anim-fade-up" style="margin-bottom:1.5rem;">
    <div class="dash-eyebrow">Data Kelas Saya</div>
    <h1 class="dash-title">Data Siswa Per Kelas</h1>
    <p class="dash-subtitle">Daftar seluruh siswa pada kelas yang Anda ampu.</p>
</div>
            ...
            <tbody id="studentTbody">
                ...
                @forelse($classes as $class)
                    ...
                    <tr class="class-sep-row" data-sep-for="class-{{ $class->id }}">
                        <td colspan="7" style="padding:.6rem 1.5rem;background:rgba(37,40,66,.55);border-bottom:1px solid rgba(103,111,157,.18);">
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="empty-state">
                                ...
                                <p class="empty-sub">Belum ada kelas yang Anda ampu saat ini.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
...
<script>
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            // show/hide student rows + renumber
            let visibleNo = 1;
