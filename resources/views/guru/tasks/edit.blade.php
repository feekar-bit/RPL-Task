...
<div class="anim-fade-up" style="margin-bottom:1.75rem;">
    ...
    <h1 class="dash-title">Edit Tugas</h1>
    <p class="dash-subtitle">Perbarui detail tugas yang diberikan ke siswa.</p>
</div>
...
<div class="create-layout">
    ...
    <div class="form-card anim-fade-right delay-1">
        ...
        <div class="form-topbar">
            ...
            <div class="form-topbar-sub">Perbarui informasi yang dibutuhkan di bawah ini.</div>
        </div>
        ...
        <div class="form-body">
            ...
            <form action="/guru/tasks/update/{{ $task->id }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="fields-grid-2">
                    ...
                    <div class="field-group field-full">
                        ...
                        <textarea name="description" rows="5"
                                  ...
                                  placeholder="Jelaskan instruksi, tujuan, dan kriteria penilaian tugas…">{{ old('description', $task->description) }}</textarea>
                    </div>
                ...
                <div class="fields-grid-2">
                    ...
                    <div class="field-group">
                        ...
                        <select name="class_id" class="field-input" required>
                            <option value="" disabled>Pilih Target Kelas</option>
                            @if(isset($classes) && count($classes) > 0)
                                @foreach($classes as $c)
                                    <option value="{{ $c->id }}" {{ (old('class_id', $task->class_id) == $c->id) ? 'selected' : '' }}>
                                        {{ $c->name }}
                                    </option>
                                @endforeach
                            @endif
