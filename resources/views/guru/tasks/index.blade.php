...
<div class="anim-fade-up" style="margin-bottom:1.5rem;">
    ...
    <h1 class="dash-title">Kelola Tugas</h1>
    <p class="dash-subtitle">Buat, edit, dan pantau semua tugas yang sudah kamu buat.</p>
</div>
            ...
            <tbody>
                ...
                @forelse($tasks as $task)
                    ...
                    <tr>
                        ...
                        {{-- Kelas --}}
                        <td>
                            <span class="class-badge">{{ $task->schoolClass?->name ?? ($task->class_id ?? '-') }}</span>
                        </td>
