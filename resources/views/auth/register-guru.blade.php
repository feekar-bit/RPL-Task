...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .orb-1 { width: 420px; height: 420px; background: rgba(103,111,157,0.12); top: -80px; left: -100px; animation-duration: 16s; }
        .orb-2 { width: 320px; height: 320px; background: rgba(249,177,122,0.07); bottom: 10%; right: -80px; animation-duration: 12s; animation-delay: -4s; }
        ...
        /* ── LEFT PANEL — slate-toned for Guru ── */
        .auth-left {
            flex: 1; padding: 3rem 2.5rem;
            display: flex; flex-direction: column; justify-content: space-between;
            background: linear-gradient(145deg, rgba(66,71,105,0.55) 0%, rgba(45,50,80,0.25) 100%);
        ...
        .auth-left::after {
            ...
            background: radial-gradient(circle, rgba(103,111,157,0.18) 0%, transparent 70%);
            pointer-events: none;
        }
        ...
        /* Guru badge — slate toned */
        .left-badge {
            display: inline-flex; align-items: center; gap: 0.45rem;
            background: rgba(103,111,157,0.14); border: 1px solid rgba(103,111,157,0.32);
            color: var(--slate); padding: 0.38rem 0.9rem; border-radius: 100px;
            font-size: 0.68rem; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase;
            margin-bottom: 1.4rem; width: fit-content;
        }
        .left-badge .dot {
            width: 5px; height: 5px; background: var(--slate);
            border-radius: 50%; box-shadow: 0 0 5px var(--slate);
        ...
        .left-title .hl {
            background: linear-gradient(130deg, var(--slate) 0%, #a0a8d4 100%);
        ...
        .feat-pill {
            ...
            font-size: 0.82rem; color: rgba(255,255,255,0.52); font-weight: 400;
        }
        .feat-icon {
            width: 30px; height: 30px; border-radius: 8px; flex-shrink: 0;
            background: rgba(103,111,157,0.18); border: 1px solid rgba(103,111,157,0.28);
        ...
        .field-input:focus {
            ...
            background: rgba(103,111,157,0.07);
            box-shadow: 0 0 0 3px rgba(103,111,157,0.18);
        }
        ...
        .toggle-password:hover { color: var(--slate); }

        /* Guru submit — slate-accented */
        .btn-submit {
            width: 100%;
            background: linear-gradient(135deg, var(--slate) 0%, #7a83b0 100%);
            color: var(--white);
            font-family: 'Plus Jakarta Sans', sans-serif;
            font-weight: 700; font-size: 0.9rem;
            padding: 0.8rem; border-radius: 11px; border: none; cursor: pointer;
            letter-spacing: 0.01em;
            box-shadow: 0 4px 24px rgba(103,111,157,0.3);
            transition: all 0.22s ease; margin-top: 0.3rem;
        }
        .btn-submit:hover {
            background: linear-gradient(135deg, #7a83b0 0%, #8990be 100%);
            box-shadow: 0 6px 32px rgba(103,111,157,0.45);
    ...
    <div class="auth-page">
        <div class="auth-card">
            ...
            <div class="auth-left anim-fade-left">
                ...
                <div class="left-body">
                    <div class="left-badge"><span class="dot"></span> Daftar Akun Guru</div>
                    <h2 class="left-title">
                        Bergabung sebagai<br><span class="hl">Guru Pengajar</span>
                    </h2>
                    <p class="left-desc">
                        Daftarkan akunmu sebagai guru RPL untuk mulai membuat tugas,
                        menilai pekerjaan siswa, dan mengelola kelas secara efisien.
                    </p>
                    <div class="left-features">
                        <div class="feat-pill">
                            <div class="feat-icon">📋</div>
                            Buat & distribusikan tugas ke kelas
                        </div>
                        <div class="feat-pill">
                            <div class="feat-icon">✅</div>
                            Nilai pekerjaan & beri feedback langsung
                        </div>
                        <div class="feat-pill">
                            <div class="feat-icon">📊</div>
                            Laporan progress seluruh kelas
                        </div>
                    </div>
                </div>
            ...
            <div class="auth-right anim-fade-right">
                <div class="form-heading">Buat Akun Guru</div>
                <p class="form-subheading">Lengkapi data diri dan ID guru kamu</p>
                ...
                <form action="{{ route('register.guru.process') }}" method="POST">
                    @csrf

                    {{-- ID GURU --}}
                    <div class="field-group">
                        <label class="field-label">ID Guru RPL</label>
                        <input type="text" name="teacher_id" class="field-input"
                            placeholder="Masukkan ID guru kamu"
                            value="{{ old('teacher_id') }}">
                        <div class="field-hint">ID ini diberikan oleh pihak sekolah / admin.</div>
                    </div>
                    ...
                    <button type="submit" class="btn-submit">Daftar sebagai Guru</button>
