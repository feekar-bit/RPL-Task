...
<style>
    ...
    .avatar-img {
        ...
        object-fit:cover;
        border:2.5px solid rgba(249,177,122,.38);
        box-shadow:0 0 24px rgba(249,177,122,.14); display:block;
    }
    .avatar-initials {
        width:100px; height:100px; border-radius:22px;
        background:linear-gradient(135deg,var(--mid) 0%,var(--slate) 100%);
        border:2.5px solid rgba(249,177,122,.38);
        box-shadow:0 0 24px rgba(249,177,122,.14);
    ...
    .avatar-cam {
        ...
        display:grid; place-items:center;
        box-shadow:0 2px 12px rgba(249,177,122,.45);
    ...
    .btn-save {
        ...
        box-shadow:0 4px 22px rgba(249,177,122,.28);
    ...
    .btn-back {
        ...
        padding:.75rem 1.4rem; border-radius:11px;
        border:1.5px solid rgba(103,111,157,.26);
    ...
    @media (max-width:900px) {
        ...
        .identity-card,.info-card { flex:1 1 220px; }
    }
...
<div class="dash-header anim-fade-up" style="margin-bottom:1.75rem;">
    ...
    <h1 class="dash-title">Profile Saya</h1>
...
<div class="profile-layout">
    ...
    <div class="profile-left">
        ...
        <div class="identity-card anim-fade-left delay-1">
            ...
            <div class="identity-role"><span class="dot"></span> Siswa</div>
        </div>
        ...
        <div class="info-card anim-fade-left delay-2">
            ...
            <div class="info-row">
                ...
                <span class="info-row-val accent">Siswa</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-row-val">{{ Auth::user()->attendance_number ?? '-' }}</span>
            </div>
            <div class="info-row">
    ...
    <div class="profile-right anim-fade-right delay-1">
        ...
        <div class="form-body">
            ...
            <form action="/siswa/profile/update" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
    ...
    function handleFileChange(input) {
        ...
        reader.onload = function(e) {
            ...
            if (img) { img.src = e.target.result; }
                ...
                newImg.src = e.target.result; newImg.className = 'avatar-img'; newImg.id = 'avatarPreview'; newImg.alt = 'Preview';
